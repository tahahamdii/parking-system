...
public class ReportingServiceTest {
    ...
    @Test
    public void generateReportOfAllParkedVehiclesTest() throws Exception{
        ...
        mockMvc.perform(get("/reports/parkedVehicles")
    ...
    @Test
    public void generateRevenueReportTest() throws Exception{
        Map<String, String> pagination = new HashMap<>();
        pagination.put("page", "0");
        pagination.put("size", "5");
        pagination.put("frequency", Frequency.MONTHLY.name());

        MultiValueMap<String, String> paginationMap = new LinkedMultiValueMap<>();
        paginationMap.setAll(pagination);

        mockMvc.perform(get("/reports/revenues")
                        .header("Authorization", "Bearer " + token)
                        .params(paginationMap))
                .andDo(print())
                .andExpect(status().isOk());
